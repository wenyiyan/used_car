...
def regression():
	...
	if request.method == 'POST':
		...
		## input box:
		origin_data[46] = int(user_input['age_month'][0])  #age_month
		origin_data[14] = int(user_input['miles'][0])      #mile
	...
	return render_template('results.html',prediction = my_prediction,name = user_input,transmission = 'transmission',year = 'year')
